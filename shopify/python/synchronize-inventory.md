...
Complete the [Python installation and configuration](../python.html) first. Both location arguments are required, keeping the source-to-target relationship visible.
...
|---|---|
| CLI arguments, safety, and output | `src/tracezilla_shopify/inventory_cli.py` |
| Matching, mapping, and decisions | `src/tracezilla_shopify/inventory.py` |
| Shopify pagination and guarded writes | `src/tracezilla_shopify/inventory_services.py` |
| tracezilla warehouse inventory | `src/tracezilla_shopify/inventory_services.py` |
