...
Complete the [Java installation and configuration](../java.html) first. Both location arguments are required, keeping the source-to-target relationship visible.
...
set +a
mvn package
java -jar target/tracezilla-shopify-java-0.1.0.jar synchronize-inventory \
...
|---|---|
| CLI arguments, safety, and output | `src/main/java/com/happybananas/tracezilla/Main.java` |
| Matching, mapping, and decisions | `src/main/java/com/happybananas/tracezilla/workflow/SynchronizeInventory.java` |
| Shopify pagination and guarded writes | `src/main/java/com/happybananas/tracezilla/InventoryServices.java` |
| tracezilla warehouse inventory | `src/main/java/com/happybananas/tracezilla/InventoryServices.java` |
